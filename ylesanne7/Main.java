...
// CSV data + method
        ...
        productsToCSV(productList);

    }

    public static void productsToCSV(List<Product> products) throws IOException {
        FileWriter csvWriter = new FileWriter("myCSV.csv");
        for(Product product : products){
            csvWriter.append(product.getName() + "," + product.getSize());
            csvWriter.append("\n");
        }
